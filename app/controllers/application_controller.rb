class ApplicationController < ActionController::Base
  ...
  before_filter :configure_permitted_parameters, :configure_r_permitted_parameters, if: :devise_controller?
  ...
  protected
    ...
    devise_parameter_sanitizer.for(:account_update) do |t|
      t.permit(:firm_name,:email, :password, :password_confirmation, :current_password, :firm_type, :firm_number, :firm_address, :address,:city,:state, :country, :pincode, :account_status,:subscribed_plan, :contact_person_name, :contact_person_email, :contact_person_number)
    end
